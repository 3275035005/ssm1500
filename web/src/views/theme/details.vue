      ...
      <div class="user-info-container">
        <div class="user-info-details">
          ...
          <div class="user-info-details-text">
            ...
            <div class="user-info-details-text-time">是否热推：<el-tag v-if="item.recommendState == 1">是</el-tag> <el-tag v-else type="danger">否</el-tag></div>
            <div class="user-info-details-text-time">发布时间：{{ item.createTime }}</div>
          </div>
        </div>
      </div>
      <div class="idle-details-container">
        <div class="details-info">
          <div class="details-info-title">主题简介:</div>
