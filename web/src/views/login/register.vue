  ...
  <div class="sign-in-container">
    <el-card class="box-card">
      <div class="sign-in-body">
        ...
        <el-input placeholder="请输入姓名..." maxlength="30" v-model="userInfo.name" class="sign-in-input" clearable>

        </el-input>
        <el-select v-model="userInfo.sex" clearable placeholder="请选择性别..." class="sign-in-input"
                   style="width: 100%">
          <el-option value="0" label="女"/>
          <el-option value="1" label="男"/>
        </el-select>
        <el-input-number v-model="userInfo.age" :min="1" :max="100" placeholder="请输入年龄..." class="sign-in-input"
                         style="width: 100%"></el-input-number>

        <el-input placeholder="请输入账号..." v-model="userInfo.username" class="sign-in-input" clearable>
        ...
        <div class="login-container">
          <span @click="toLogin" class="login-text">返回登录</span>
        </div>
      </div>
    </el-card>
  </div>
  ...
  methods: {
    ...
    signIn() {
      if (this.userInfo.username && this.userInfo.password) {
        if (this.userInfo.password !== this.userPassword2) {
