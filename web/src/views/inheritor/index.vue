        ...
        <app-body>
          <el-form ref="form" style="margin-top: 10px" :model="queryData" label-width="120px">
            <el-form-item label="传承人姓名">
              <el-input v-model="queryData.name" style="width: 300px;margin-right: 30px"></el-input>
...
<script>
    ...
    import { inheritorPageQuery } from '@/api';
    export default {
        name: "index",
        components: {
            AppHead,
        ...
        methods: {
            ...
            getData(){
              ...
              inheritorPageQuery(this.currentPage,this.pageSize, this.queryData).then(res=>{
            ...
            // 跳转页码详情
            toDetails(id) {
                this.$router.push({path: '/idetails', query: {id: id}});
            }
        }
    }
</script>
