  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="姓名">
        <el-input clearable size="small" v-model="formInline.name" placeholder="请输入姓名"></el-input>
      </el-form-item>
    ...
    <el-table size="small" :data="list" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center"  prop="birthDate" label="生日"></el-table-column>
    ...
    <el-dialog
      ...
      <el-form label-width="120px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="姓名" prop="name">
          <el-input size="small" v-model="editForm.name" auto-complete="off" placeholder="请输入项目姓名"></el-input>
        </el-form-item>
        <el-form-item label="民族" prop="nation">
          <el-input size="small" v-model="editForm.nation" auto-complete="off" placeholder="请输入民族"></el-input>
        </el-form-item>
...
<script>
// 导入请求方法
import {list,save,deleteById,update } from '@/api/inheritor'
