<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>非遗物品信息</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="物品名称">
        <el-input clearable size="small" v-model="formInline.title" placeholder="请输入物品名称"></el-input>
      </el-form-item>
    ...
    <el-table size="small" :data="list" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center"  prop="title" label="物品名称"></el-table-column>
      <el-table-column align="center"  prop="price" label="物品单价"></el-table-column>
      <el-table-column align="center"  prop="status" label="状态" >
        <template slot-scope="scope">
          <el-tag v-if="scope.row.status==0" type="success">下架</el-tag>
          <el-tag v-if="scope.row.status==1" type="warning">上架</el-tag>
        </template>
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form label-width="120px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="物品名称" prop="title">
          <el-input size="small" v-model="editForm.title" auto-complete="off" placeholder="请输入物品名称"></el-input>
        </el-form-item>
        <el-form-item label="物品单价" prop="price">
          <el-input size="small" v-model="editForm.price" auto-complete="off" placeholder="请输入物品单价"></el-input>
        </el-form-item>
        ...
        <el-form-item label="物品介绍">
          <tinymce :height="300" v-model="editForm.content"/>
        </el-form-item>
      </el-form>
...
<script>
// 导入请求方法
import {list,save,deleteById,update } from '@/api/goods'
