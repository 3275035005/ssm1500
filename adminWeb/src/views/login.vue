<template>
  <div class="login-wrap">
    <div style="text-align: center; margin-bottom: 30px; font-size: 30px">非物质文化遗产管理系统</div>
    ...
    <el-row :gutter="20" class="footer">
       <el-col :span="12" :offset="11"><div><span>Copyright © 2023  非物质文化遗产推广平台</span></div></el-col>
    </el-row>
  </div>
</template>
